...
public class HazelcastWorkQueue implements WorkQueue{
    ...
    public void start(){
        ...
        if (hcInstance == null) {
            ...
            // initialization such that Hazelcast initialization log output ends up at stout.
            // This problem is resolved by setting a system property as shown below.
            ...
            hcConfig.setProperty( "hazelcast.phone.home.enabled", "false" );
            hcConfig.setInstanceName( hcInstanceName );
            hcConfig.setClusterName( config.getClusterName() );
    ...
    public void awaitEmpty(){
        ...
        UUID registrationId = getWorkQueue().addItemListener( listener, includeItemValuesInNotificationEvents );
