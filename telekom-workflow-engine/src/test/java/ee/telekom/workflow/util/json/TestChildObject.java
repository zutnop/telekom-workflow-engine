...
public class TestChildObject extends TestObject {
	...
	private Date _Date;
	private TestChildObject _TestObject;

	private TestChildObject[] _array;
	private List<TestChildObject> _list;
	private Set<TestChildObject> _set;
	private Map<String, TestChildObject> _map;

	public static TestChildObject createComplex() {
		TestChildObject result = createSimple();
		result._TestObject = createSimple();
		result._array = new TestChildObject[]{createSimple(), null,
				createSimple()};
	...
	public static TestChildObject createSimple() {
	...
	public static TestChildObject create(boolean _boolean, byte _byte,
			short _short, int _int, long _long, float _float, double _double,
			BigInteger _BigInteger, BigDecimal _BigDecimal, String _String,
			TestEnum _TestEnum, Date _Date) {
		TestChildObject result = new TestChildObject();
		result.setChildValues(_boolean, _byte, _short, _int, _long, _float,
				_double, _BigInteger, _BigDecimal, _String, _TestEnum, _Date);
		result.set(!_boolean, (byte) (_byte - 1), (short) (_short - 1),
				_int - 1, _long - 1, _float - 1, _double - 1,
				_BigInteger.add(new BigInteger("2")),
				_BigDecimal.add(new BigDecimal("2.0")), _String + "test",
				_TestEnum, _Date);
		return result;
	}

	protected void setChildValues(boolean _boolean, byte _byte, short _short,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof TestChildObject)) {
			return false;
		}
